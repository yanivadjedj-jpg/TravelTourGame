...
namespace TravelTour.Core
{
    ...
    public static class PlayerSave
    {
        ...
        public static bool[]       StoryProgress  = new bool[78];  // 78 chapitres
    ...
    public static partial class Catalog
    {
        ...
        public static List<CharacterData> Characters = new()
        {
            ...
            new(){ Name="Raiki Mugen",   Rarity=Rarity.Legendary, MaxHP=192, BaseAtk=35, BaseDef=15, BaseSpeed=10, MaxChakra=305, IsOwned=false, BuyPrice=14000, Icon="🔮" },
            new(){ Name="Kaze Mugen",    Rarity=Rarity.Legendary, MaxHP=186, BaseAtk=33, BaseDef=13, BaseSpeed=13, MaxChakra=295, IsOwned=false, BuyPrice=15000, Icon="🌬️" },
            new(){ Name="Riku Zantetsu", Rarity=Rarity.Legendary, MaxHP=193, BaseAtk=36, BaseDef=14, BaseSpeed=12, MaxChakra=310, IsOwned=false, BuyPrice=17000, Icon="🗻" },
            new(){ Name="Hana Mugen",    Rarity=Rarity.Legendary, MaxHP=187, BaseAtk=34, BaseDef=14, BaseSpeed=12, MaxChakra=298, IsOwned=false, BuyPrice=19000, Icon="🌹" },
            ...
            new(){ Name="Kurenai Yasha",    Rarity=Rarity.Legendary, MaxHP=194, BaseAtk=37, BaseDef=15, BaseSpeed=12, MaxChakra=312, IsOwned=false, BuyPrice=15000, Icon="🔴" },
            new(){ Name="Seiryu Kokua",     Rarity=Rarity.Legendary, MaxHP=197, BaseAtk=38, BaseDef=15, BaseSpeed=13, MaxChakra=318, IsOwned=false, BuyPrice=18000, Icon="🦈" },
            new(){ Name="Kaiga Ryusen",     Rarity=Rarity.Legendary, MaxHP=196, BaseAtk=38, BaseDef=15, BaseSpeed=13, MaxChakra=316, IsOwned=false, BuyPrice=17000, Icon="🌈" },
            ...
            new(){ Name="Kurōkami Setsuna",  Rarity=Rarity.Legendary, MaxHP=199, BaseAtk=40, BaseDef=15, BaseSpeed=13, MaxChakra=326, IsOwned=false, BuyPrice=20000, Icon="🖤" },
            ...
            new(){ Name="Ryoko Mugen",       Rarity=Rarity.Epic,      MaxHP=175, BaseAtk=32, BaseDef=12, BaseSpeed=12, MaxChakra=285, IsOwned=false, BuyPrice=12000, Icon="🌊" },
        ...
        public static List<WeaponData> Weapons = new()
        {
            ...
            new(){ Name="Gantelet de l'Aube",        Type=WeaponType.Gauntlet, BaseDamage=62,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=5300,  Icon="🌄",  Costs=new(){ new(){Material="CristalFeu",    Quantity=2}, new(){Material="EclatFoudre",   Quantity=1} } },
            new(){ Name="Faux des Étoiles Mortes",   Type=WeaponType.Scythe,   BaseDamage=88,  Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=13000, Icon="🌟",  Costs=new(){ new(){Material="EssenceOmbres", Quantity=4}, new(){Material="GemmeLunaire",  Quantity=3} } },
            new(){ Name="Arc des Vents Glacés",      Type=WeaponType.Bow,      BaseDamage=64,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=5600,  Icon="🌬️", Costs=new(){ new(){Material="GemmeLunaire",  Quantity=2}, new(){Material="EclatFoudre",   Quantity=2} } },
            ...
            new(){ Name="Sceptre de Givre",           Type=WeaponType.Staff,    BaseDamage=62,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=5200,  Icon="🧊",  Costs=new(){ new(){Material="GemmeLunaire",  Quantity=2}, new(){Material="CristalFeu",    Quantity=1} } },
            new(){ Name="Poing du Néant",             Type=WeaponType.Gauntlet, BaseDamage=87,  Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=12500, Icon="⬛",  Costs=new(){ new(){Material="EssenceOmbres", Quantity=4}, new(){Material="CristalNoir",   Quantity=2} } },
            new(){ Name="Arc du Néant Glacé",         Type=WeaponType.Bow,      BaseDamage=65,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=5800,  Icon="🌌",  Costs=new(){ new(){Material="EssenceOmbres", Quantity=2}, new(){Material="GemmeLunaire",  Quantity=2} } },
            new(){ Name="Faux de l'Aube Sanglante",   Type=WeaponType.Scythe,   BaseDamage=128, Rarity=Rarity.Legendary, IsOwned=false, BuyPrice=23000, Icon="🌅",  Costs=new(){ new(){Material="AmeDechue",     Quantity=4}, new(){Material="CristalNoir",   Quantity=4} } },
            new(){ Name="Bouclier des Âmes Liées",    Type=WeaponType.Shield,   BaseDamage=62,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=5900,  Icon="🔵",  Costs=new(){ new(){Material="EssenceOmbres", Quantity=2}, new(){Material="GemmeLunaire",  Quantity=2} } },
            new(){ Name="Gantelet de l'Éon Brisé",   Type=WeaponType.Gauntlet, BaseDamage=135, Rarity=Rarity.Legendary, IsOwned=false, BuyPrice=24000, Icon="🌋",  Costs=new(){ new(){Material="AmeDechue",     Quantity=4}, new(){Material="PierreCeleste", Quantity=4} } },
            new(){ Name="Arc des Âmes Stellaires",    Type=WeaponType.Bow,      BaseDamage=66,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=6100,  Icon="✨",  Costs=new(){ new(){Material="EclatFoudre",   Quantity=3}, new(){Material="GemmeLunaire",  Quantity=2} } },
            new(){ Name="Gantelets du Néant Absolu",  Type=WeaponType.Gauntlet, BaseDamage=93,  Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=14500, Icon="🌑",  Costs=new(){ new(){Material="EssenceOmbres", Quantity=5}, new(){Material="CristalNoir",   Quantity=3} } },
            new(){ Name="Lame du Spectre Céleste",    Type=WeaponType.Sword,    BaseDamage=68,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=6300,  Icon="👁️",  Costs=new(){ new(){Material="EclatFoudre",   Quantity=3}, new(){Material="GemmeLunaire",  Quantity=2} } },
            new(){ Name="Sceptre des Abysses Glacées",Type=WeaponType.Staff,    BaseDamage=97,  Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=15500, Icon="🧊",  Costs=new(){ new(){Material="CristalNoir",   Quantity=5}, new(){Material="GemmeLunaire",  Quantity=3} } },
            new(){ Name="Bâton des Vents Sacrés",    Type=WeaponType.Staff,    BaseDamage=64,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=5400,  Icon="🌬️", Costs=new(){ new(){Material="EclatFoudre",   Quantity=3}, new(){Material="LarmePhoenix",  Quantity=1} } },
            ...
            new(){ Name="Lame du Crépuscule Ardent",  Type=WeaponType.Sword,    BaseDamage=65,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=5800,  Icon="🌅",  Costs=new(){ new(){Material="CristalFeu",    Quantity=2}, new(){Material="LarmePhoenix",  Quantity=2} } },
            new(){ Name="Sceptre du Cosmos Brisé",    Type=WeaponType.Staff,    BaseDamage=97,  Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=15000, Icon="🌌",  Costs=new(){ new(){Material="PierreCeleste", Quantity=4}, new(){Material="EssenceOmbres", Quantity=3} } },
            new(){ Name="Bâton des Abysses Sacrées", Type=WeaponType.Staff,    BaseDamage=66,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=6100,  Icon="🌊",  Costs=new(){ new(){Material="EssenceOmbres", Quantity=2}, new(){Material="CristalNoir",   Quantity=1} } },
            ...
            new(){ Name="Katana des Flammes Spectrales", Type=WeaponType.Sword,    BaseDamage=67,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=6500,  Icon="🔴",  Costs=new(){ new(){Material="CristalFeu",    Quantity=3}, new(){Material="LarmePhoenix",  Quantity=1} } },
            new(){ Name="Gantelet de l'Éternité Sacrée",Type=WeaponType.Gauntlet, BaseDamage=138, Rarity=Rarity.Legendary, IsOwned=false, BuyPrice=24000, Icon="✨",  Costs=new(){ new(){Material="AmeDechue",     Quantity=4}, new(){Material="PierreCeleste", Quantity=4} } },
            new(){ Name="Bâton des Âmes Cristallines",  Type=WeaponType.Staff,    BaseDamage=63,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=5350,  Icon="🔷",  Costs=new(){ new(){Material="GemmeLunaire",  Quantity=2}, new(){Material="EssenceOmbres", Quantity=1} } },
            new(){ Name="Faux du Soleil Cramoisi",       Type=WeaponType.Scythe,   BaseDamage=90,  Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=14000, Icon="🌹",  Costs=new(){ new(){Material="LarmePhoenix",  Quantity=4}, new(){Material="CristalFeu",    Quantity=3} } },
            new(){ Name="Katana de la Tempête Noire",    Type=WeaponType.Sword,    BaseDamage=68,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=6200,  Icon="🌑",  Costs=new(){ new(){Material="EssenceOmbres", Quantity=3}, new(){Material="EclatFoudre",   Quantity=2} } },
            new(){ Name="Bouclier du Cosmos Ardent",     Type=WeaponType.Shield,   BaseDamage=85,  Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=13500, Icon="🌌",  Costs=new(){ new(){Material="PierreCeleste", Quantity=4}, new(){Material="EssenceOmbres", Quantity=3} } },
            new(){ Name="Arc du Vent Fantôme",           Type=WeaponType.Bow,      BaseDamage=63,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=5750,  Icon="💨",  Costs=new(){ new(){Material="EclatFoudre",   Quantity=2}, new(){Material="GemmeLunaire",  Quantity=2} } },
            new(){ Name="Faux du Cosmos Ardent",         Type=WeaponType.Scythe,   BaseDamage=91,  Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=14000, Icon="🌅",  Costs=new(){ new(){Material="EssenceOmbres", Quantity=5}, new(){Material="CristalNoir",   Quantity=3} } },
            new(){ Name="Katana de l'Aube Cramoisie",    Type=WeaponType.Sword,    BaseDamage=70,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=6800,  Icon="🌸",  Costs=new(){ new(){Material="LarmePhoenix",  Quantity=3}, new(){Material="CristalFeu",    Quantity=2} } },
            ...
            new(){ Name="Faux du Vent Maudit",           Type=WeaponType.Scythe,   BaseDamage=66,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=5900,  Icon="💀",  Costs=new(){ new(){Material="EssenceOmbres", Quantity=2}, new(){Material="GemmeLunaire",  Quantity=2} } },
            new(){ Name="Lance de l'Abîme Stellaire",    Type=WeaponType.Staff,    BaseDamage=145, Rarity=Rarity.Legendary, IsOwned=false, BuyPrice=25000, Icon="🌟",  Costs=new(){ new(){Material="AmeDechue",     Quantity=5}, new(){Material="PierreCeleste", Quantity=4} } },
            new(){ Name="Lame de l'Équinoxe",            Type=WeaponType.Bow,      BaseDamage=66,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=5900,  Icon="🌗",  Costs=new(){ new(){Material="EclatFoudre",   Quantity=2}, new(){Material="GemmeLunaire",  Quantity=2} } },
            new(){ Name="Gantelet du Cosmos",             Type=WeaponType.Gauntlet, BaseDamage=91,  Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=13500, Icon="🌐",  Costs=new(){ new(){Material="PierreCeleste", Quantity=4}, new(){Material="AmeDechue",     Quantity=2} } },
            new(){ Name="Arc des Runes Glacées",          Type=WeaponType.Bow,      BaseDamage=67,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=6500,  Icon="❄️",  Costs=new(){ new(){Material="EclatFoudre",   Quantity=2}, new(){Material="GemmeLunaire",  Quantity=2} } },
            ...
            new(){ Name="Lame des Marées",               Type=WeaponType.Sword,    BaseDamage=66,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=6000,  Icon="🌊",  Costs=new(){ new(){Material="EssenceOmbres", Quantity=2}, new(){Material="GemmeLunaire",  Quantity=2} } },
            new(){ Name="Faux du Destin Noir",           Type=WeaponType.Scythe,   BaseDamage=145, Rarity=Rarity.Legendary, IsOwned=false, BuyPrice=24500, Icon="🌑",  Costs=new(){ new(){Material="AmeDechue",     Quantity=5}, new(){Material="CristalNoir",   Quantity=4} } },
            new(){ Name="Arc de la Foudre Bleue",        Type=WeaponType.Bow,      BaseDamage=68,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=6600,  Icon="💙",  Costs=new(){ new(){Material="EclatFoudre",   Quantity=3}, new(){Material="GemmeLunaire",  Quantity=2} } },
            new(){ Name="Gantelets du Titan Céleste",    Type=WeaponType.Gauntlet, BaseDamage=96,  Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=15500, Icon="🌩️", Costs=new(){ new(){Material="PierreCeleste", Quantity=4}, new(){Material="EclatFoudre",   Quantity=4} } },
            new(){ Name="Katana du Vent Oublié",         Type=WeaponType.Sword,    BaseDamage=68,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=6400,  Icon="🌫️", Costs=new(){ new(){Material="EclatFoudre",   Quantity=3}, new(){Material="GemmeLunaire",  Quantity=2} } },
            ...
            new(){ Name="Épée du Nexus Ardent",          Type=WeaponType.Sword,    BaseDamage=66,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=5900,  Icon="🔶",  Costs=new(){ new(){Material="CristalFeu",    Quantity=2}, new(){Material="EclatFoudre",   Quantity=2} } },
            ...
            new(){ Name="Faucille du Crépuscule Lunaire",   Type=WeaponType.Scythe,   BaseDamage=71,  Rarity=Rarity.Rare,      IsOwned=false, BuyPrice=6900,  Icon="🌙",  Costs=new(){ new(){Material="GemmeLunaire",  Quantity=3}, new(){Material="EssenceOmbres", Quantity=2} } },
        ...
        public static List<VehicleData> Vehicles = new()
        {
            ...
            new(){ Name="Cristal Volant",        Icon="💠", Speed=22, Acceleration=15, TrickBonus=1.55f,Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=13500 },
            new(){ Name="Kitsune Fantôme",       Icon="🦊", Speed=21, Acceleration=15, TrickBonus=1.35f,Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=11500 },
            new(){ Name="Chronos Glider",        Icon="⏳", Speed=23, Acceleration=16, TrickBonus=1.6f, Rarity=Rarity.Legendary, IsOwned=false, BuyPrice=19000 },
            new(){ Name="Aile du Destin",         Icon="🦋", Speed=22, Acceleration=16, TrickBonus=1.55f,Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=12500 },
            ...
            new(){ Name="Nebula Bolt",                  Icon="💜", Speed=24, Acceleration=17, TrickBonus=1.70f, Rarity=Rarity.Legendary, IsOwned=false, BuyPrice=21000 },
            new(){ Name="Magnetron Drift",              Icon="🧲", Speed=22, Acceleration=16, TrickBonus=1.55f, Rarity=Rarity.Epic,      IsOwned=false, BuyPrice=13000 },
            new(){ Name="Astral Viper",                  Icon="🐍", Speed=24, Acceleration=17, TrickBonus=1.70f, Rarity=Rarity.Legendary, IsOwned=false, BuyPrice=20000 },
            ...
            new(){ Name="Ryūjin Cyclone",                  Icon="🐉", Speed=26, Acceleration=19, TrickBonus=1.90f, Rarity=Rarity.Legendary, IsOwned=false, BuyPrice=24000 },
            ...
            new(){ Name="Éclair Abyssal",                    Icon="⚡", Speed=23, Acceleration=17, TrickBonus=1.68f, Rarity=Rarity.Legendary, IsOwned=false, BuyPrice=19000 },
        ...
        public static List<DungeonData> Dungeons = new()
        {
            ...
            new(){ Name="Vallée des Cristaux Dormants", Icon="💎", Difficulty=DifficultyLevel.Easy, RequiredRank=0, EnemyCount=5,  GoldReward=125,  Rewards=new(){ new(){Material="CristalFeu",    Min=1, Max=3}, new(){Material="GemmeLunaire",  Min=1, Max=2} } },
            new(){ Name="Citadelle du Phénix Maudit",  Icon="🦅", Difficulty=DifficultyLevel.Boss, RequiredRank=5, EnemyCount=6,  GoldReward=660,  Rewards=new(){ new(){Material="LarmePhoenix",  Min=2, Max=4}, new(){Material="EssenceOmbres", Min=1, Max=2} } },
            new(){ Name="Abîme des Rêves Brisés",           Icon="💫", Difficulty=DifficultyLevel.Medium,    RequiredRank=1, EnemyCount=9,  GoldReward=190,  Rewards=new(){ new(){Material="GemmeLunaire",  Min=1, Max=3}, new(){Material="EclatFoudre",   Min=1, Max=2} } },
            ...
            new(){ Name="Abîme des Flammes Ancestrales", Icon="🔥", Difficulty=DifficultyLevel.Easy,   RequiredRank=0, EnemyCount=6,  GoldReward=130,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="EclatFoudre",   Min=1, Max=2} } },
            new(){ Name="Bastion du Chaos Ancien",       Icon="🌑", Difficulty=DifficultyLevel.Boss,   RequiredRank=5, EnemyCount=7,  GoldReward=670,  Rewards=new(){ new(){Material="AmeDechue",     Min=1, Max=2}, new(){Material="GemmeLunaire",  Min=1, Max=3} } },
            new(){ Name="Caverne des Cristaux Glacés",   Icon="🧊", Difficulty=DifficultyLevel.Easy,   RequiredRank=0, EnemyCount=7,  GoldReward=135,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="EclatFoudre",   Min=1, Max=2} } },
            new(){ Name="Tour des Ombres Éternelles",    Icon="🌑", Difficulty=DifficultyLevel.Boss,   RequiredRank=5, EnemyCount=8,  GoldReward=710,  Rewards=new(){ new(){Material="AmeDechue",     Min=1, Max=2}, new(){Material="EssenceOmbres", Min=2, Max=4} } },
            new(){ Name="Grotte des Éclairs Sacrés",     Icon="⚡", Difficulty=DifficultyLevel.Easy,   RequiredRank=0, EnemyCount=6,  GoldReward=145,  Rewards=new(){ new(){Material="EclatFoudre",   Min=2, Max=4}, new(){Material="CristalFeu",    Min=1, Max=3} } },
            new(){ Name="Sanctuaire du Vide Ancestral",  Icon="🌌", Difficulty=DifficultyLevel.Boss,   RequiredRank=5, EnemyCount=9,  GoldReward=730,  Rewards=new(){ new(){Material="AmeDechue",     Min=1, Max=3}, new(){Material="CristalNoir",   Min=2, Max=4} } },
            new(){ Name="Forteresse des Tempêtes Oubliées", Icon="⚡", Difficulty=DifficultyLevel.Hard,   RequiredRank=3, EnemyCount=11, GoldReward=310,  Rewards=new(){ new(){Material="PierreCeleste", Min=1, Max=2}, new(){Material="EclatFoudre",   Min=1, Max=3} } },
            new(){ Name="Citadelle des Ombres Éternelles",  Icon="🌑", Difficulty=DifficultyLevel.Boss,   RequiredRank=5, EnemyCount=6,  GoldReward=620,  Rewards=new(){ new(){Material="AmeDechue",     Min=1, Max=2}, new(){Material="CristalNoir",   Min=2, Max=3} } },
            new(){ Name="Sanctuaire des Tempêtes Anciennes", Icon="⛈️", Difficulty=DifficultyLevel.Hard,      RequiredRank=3, EnemyCount=11, GoldReward=290,  Rewards=new(){ new(){Material="PierreCeleste", Min=1, Max=2}, new(){Material="EclatFoudre",   Min=2, Max=4} } },
            new(){ Name="Trône des Âmes Damnées",            Icon="💀", Difficulty=DifficultyLevel.Legendary, RequiredRank=6, EnemyCount=21, GoldReward=1450, Rewards=new(){ new(){Material="AmeDechue",     Min=3, Max=5}, new(){Material="CristalNoir",   Min=2, Max=4} } },
            new(){ Name="Grotte des Vents Murmurés",        Icon="🌬️", Difficulty=DifficultyLevel.Easy,      RequiredRank=0, EnemyCount=6,  GoldReward=130,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="EclatFoudre",   Min=1, Max=2} } },
            ...
            new(){ Name="Souterrain des Cendres Froides",   Icon="🌋", Difficulty=DifficultyLevel.Easy,      RequiredRank=0, EnemyCount=6,  GoldReward=125,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="EclatFoudre",   Min=1, Max=2} } },
            new(){ Name="Palais des Vents Déchirés",        Icon="💨", Difficulty=DifficultyLevel.Boss,      RequiredRank=5, EnemyCount=8,  GoldReward=720,  Rewards=new(){ new(){Material="AmeDechue",     Min=1, Max=2}, new(){Material="EssenceOmbres", Min=2, Max=4} } },
            new(){ Name="Marais des Flammes Glissantes",    Icon="🌿", Difficulty=DifficultyLevel.Easy,      RequiredRank=0, EnemyCount=7,  GoldReward=140,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="EclatFoudre",   Min=1, Max=3} } },
            ...
            new(){ Name="Caverne des Éclats Stellaires", Icon="⭐", Difficulty=DifficultyLevel.Easy,      RequiredRank=0, EnemyCount=6,  GoldReward=140,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="EclatFoudre",   Min=1, Max=2} } },
            new(){ Name="Nécropole du Vide Ancestral",   Icon="💀", Difficulty=DifficultyLevel.Legendary, RequiredRank=6, EnemyCount=19, GoldReward=1350, Rewards=new(){ new(){Material="AmeDechue",     Min=2, Max=4}, new(){Material="CristalNoir",   Min=2, Max=3} } },
            new(){ Name="Bosquet des Cristaux Sacrés",       Icon="💎", Difficulty=DifficultyLevel.Easy,      RequiredRank=0, EnemyCount=6,  GoldReward=135,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="EclatFoudre",   Min=1, Max=2} } },
            new(){ Name="Forteresse des Ombres Stellaires",  Icon="🌟", Difficulty=DifficultyLevel.Hard,      RequiredRank=3, EnemyCount=12, GoldReward=305,  Rewards=new(){ new(){Material="PierreCeleste", Min=1, Max=2}, new(){Material="EssenceOmbres", Min=1, Max=3} } },
            new(){ Name="Antre des Lueurs Spectrales",        Icon="👁️", Difficulty=DifficultyLevel.Easy,      RequiredRank=0, EnemyCount=6,  GoldReward=130,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="EclatFoudre",   Min=1, Max=2} } },
            new(){ Name="Palais du Monarque Solaire",         Icon="☀️", Difficulty=DifficultyLevel.Boss,      RequiredRank=5, EnemyCount=9,  GoldReward=720,  Rewards=new(){ new(){Material="LarmePhoenix",  Min=2, Max=4}, new(){Material="AmeDechue",     Min=1, Max=2} } },
            new(){ Name="Grotte des Éclats Infernaux",        Icon="🔴", Difficulty=DifficultyLevel.Easy,      RequiredRank=0, EnemyCount=7,  GoldReward=140,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="EclatFoudre",   Min=1, Max=2} } },
            new(){ Name="Citadelle du Néant Éternel",         Icon="🌑", Difficulty=DifficultyLevel.Boss,      RequiredRank=5, EnemyCount=9,  GoldReward=740,  Rewards=new(){ new(){Material="AmeDechue",     Min=1, Max=3}, new(){Material="EssenceOmbres", Min=2, Max=4} } },
            new(){ Name="Grotte des Souffles Interdits",      Icon="🌀", Difficulty=DifficultyLevel.Medium,    RequiredRank=1, EnemyCount=9,  GoldReward=195,  Rewards=new(){ new(){Material="GemmeLunaire",  Min=1, Max=3}, new(){Material="CristalFeu",    Min=1, Max=2} } },
            ...
            new(){ Name="Crypte du Phénix Oublié",           Icon="🔥", Difficulty=DifficultyLevel.Medium,    RequiredRank=1, EnemyCount=9,  GoldReward=185,  Rewards=new(){ new(){Material="LarmePhoenix",  Min=1, Max=3}, new(){Material="CristalFeu",    Min=1, Max=2} } },
            new(){ Name="Nexus du Titan Cosmique",           Icon="🌌", Difficulty=DifficultyLevel.Legendary, RequiredRank=6, EnemyCount=21, GoldReward=1650, Rewards=new(){ new(){Material="AmeDechue",     Min=3, Max=5}, new(){Material="CristalNoir",   Min=2, Max=4} } },
            new(){ Name="Grotte des Lueurs Lunaires",        Icon="🌙", Difficulty=DifficultyLevel.Medium,    RequiredRank=1, EnemyCount=8,  GoldReward=175,  Rewards=new(){ new(){Material="GemmeLunaire",  Min=1, Max=3}, new(){Material="CristalFeu",    Min=1, Max=2} } },
            new(){ Name="Tour du Phénix Ardent",             Icon="🔮", Difficulty=DifficultyLevel.Boss,      RequiredRank=5, EnemyCount=8,  GoldReward=660,  Rewards=new(){ new(){Material="LarmePhoenix",  Min=2, Max=4}, new(){Material="EclatFoudre",   Min=2, Max=3} } },
            new(){ Name="Crypte des Souffles Oubliés",       Icon="💨", Difficulty=DifficultyLevel.Easy,      RequiredRank=0, EnemyCount=6,  GoldReward=135,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="EclatFoudre",   Min=1, Max=2} } },
            ...
            new(){ Name="Gouffre des Vents Sacrés",           Icon="🌬️", Difficulty=DifficultyLevel.Easy,      RequiredRank=0, EnemyCount=7,  GoldReward=150,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="EclatFoudre",   Min=1, Max=3} } },
            new(){ Name="Tour des Titans Stellaires",          Icon="🌟", Difficulty=DifficultyLevel.Legendary, RequiredRank=5, EnemyCount=20, GoldReward=1500, Rewards=new(){ new(){Material="AmeDechue",     Min=3, Max=5}, new(){Material="PierreCeleste", Min=2, Max=4} } },
            new(){ Name="Clairière des Âmes Dorées",           Icon="✨", Difficulty=DifficultyLevel.Easy,      RequiredRank=0, EnemyCount=7,  GoldReward=145,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="GemmeLunaire",  Min=1, Max=2} } },
            new(){ Name="Tour du Vide Ardent",                  Icon="🔥", Difficulty=DifficultyLevel.Hard,      RequiredRank=4, EnemyCount=13, GoldReward=450,  Rewards=new(){ new(){Material="EclatFoudre",   Min=2, Max=4}, new(){Material="PierreCeleste", Min=1, Max=2} } },
            new(){ Name="Crypte du Dragon Oublié",              Icon="🐉", Difficulty=DifficultyLevel.Medium,    RequiredRank=2, EnemyCount=10, GoldReward=240,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="LarmePhoenix",  Min=1, Max=2} } },
            ...
            new(){ Name="Crypte des Flammes Bleues",           Icon="🔵", Difficulty=DifficultyLevel.Easy,      RequiredRank=0, EnemyCount=6,  GoldReward=135,  Rewards=new(){ new(){Material="CristalFeu",    Min=2, Max=4}, new(){Material="EclatFoudre",   Min=1, Max=2} } },
            ...
            new(){ Name="Caverne des Larmes du Phénix",       Icon="🔥", Difficulty=DifficultyLevel.Medium,    RequiredRank=2, EnemyCount=10, GoldReward=260,  Rewards=new(){ new(){Material="LarmePhoenix",  Min=2, Max=4}, new(){Material="CristalFeu",    Min=1, Max=3} } },
